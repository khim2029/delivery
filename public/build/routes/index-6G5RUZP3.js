import {
  useOptionalUser
} from "/build/_shared/chunk-UVEBFMZ5.js";
import {
  Link,
  require_jsx_dev_runtime
} from "/build/_shared/chunk-G4CYY55V.js";
import {
  __toESM
...
function Index() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("main", { className: "relative min-h-screen bg-white sm:flex sm:items-center sm:justify-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "relative sm:pb-16 sm:pt-8", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "mx-auto max-w-7xl py-2 px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "mt-6 flex flex-wrap justify-center gap-8", children: [
      {
...
//# sourceMappingURL=/build/routes/index-6G5RUZP3.js.map
